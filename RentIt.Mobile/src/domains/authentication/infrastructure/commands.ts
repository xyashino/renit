...
import type { ApiSessionPayload } from '@/src/shared/auth';
...
export async function login(email: string, password: string): Promise<ApiSessionPayload> {
...
export async function register(input: RegisterPayload): Promise<ApiSessionPayload> {
