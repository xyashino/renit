...
namespace RentIt.Server.Migrations
{
    ...
    [Migration("20260516111319_RentalStatusAndReviewUniqueIndex")]
    partial class RentalStatusAndReviewUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentIt.Server.Models.EquipmentTag", b =>
                {
                    b.Property<int>("EquipmentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentIt.Server.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RentIt.Server.Models.EquipmentTag", b =>
                {
                    b.HasOne("RentIt.Server.Models.Equipment", "Equipment")
                        .WithMany("EquipmentTags")
                        .HasForeignKey("EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentIt.Server.Models.Tag", "Tag")
                        .WithMany("EquipmentTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
